...
const CryptoDetails = () => {
  ...
  const cryptoDetails = "Qwsogvtv82FCd";
  console.log(data);
  ...
  const stats = [
    ...
    { title: "Rank", value: ` ${cryptoDetails?.rank && millify(cryptoDetails?.rank)}`, icon: <NumberOutlined /> },
    // {
    //   title: "24h Volume",
    //   value: `$ ${cryptoDetails?.value && millify(cryptoDetails?.value)}`,
